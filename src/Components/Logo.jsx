    ...
    <div className="flex flex-row items-center gap-1">
      ...
      <div className="flex items-baseline leading-tight">
        ...
        <div className="relative">
          ...
          <div className="absolute -top-0.5 -left-0.5 sm:top-0 sm:-left-0.5 md:-top-1.5 md:left-0.5 z-10 scale-55 sm:scale-80 md:scale-100">
            {/* SVG flame for more precise curve control */}
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="5 0 102 50" className="w-[16px] h-[14px] sm:h-[18px] md:h-[21px]">
